...
# fix the search folder , don't know what is up
# fix the % flicker thing
import os
import numpy as np
...
class FindSubset:
    ...
    def __init__(self, master):        
        ...
        ttk.Label(self.main_frame, text = 'Search Directory:').grid(row = 0, column = 0, sticky = 'w')       #bug here
        self.path_entry = ttk.Entry(self.main_frame, width = 54)
        self.path_entry.grid(row = 1, column = 0, sticky = 'e')
        self.path_entry.insert(0, '.\\images') # default search folder . changed this fix this later           
